...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,inspectionId,inspectorId,batchId,farmerName,location,capturedLocation,town,chapter,exactLocation,truckNumber,company,buyerName,waybillNumber,analysisType,quantity,quantityBags,moistureContent,nutCount,kor,goodKernels,spottedKernels,immatureKernels,oilyKernels,voidKernels,fullyDamagedKernels,emptyShells,totalDefective,totalSpotted,const DeepCollectionEquality().hash(imageUrls),status,notes,createdAt,updatedAt,completedAt]);

@override
String toString() {
  return 'Inspection(id: $id, inspectionId: $inspectionId, inspectorId: $inspectorId, batchId: $batchId, farmerName: $farmerName, location: $location, capturedLocation: $capturedLocation, town: $town, chapter: $chapter, exactLocation: $exactLocation, truckNumber: $truckNumber, company: $company, buyerName: $buyerName, waybillNumber: $waybillNumber, analysisType: $analysisType, quantity: $quantity, quantityBags: $quantityBags, moistureContent: $moistureContent, nutCount: $nutCount, kor: $kor, goodKernels: $goodKernels, spottedKernels: $spottedKernels, immatureKernels: $immatureKernels, oilyKernels: $oilyKernels, voidKernels: $voidKernels, fullyDamagedKernels: $fullyDamagedKernels, emptyShells: $emptyShells, totalDefective: $totalDefective, totalSpotted: $totalSpotted, imageUrls: $imageUrls, status: $status, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt, completedAt: $completedAt)';
}
...
/// Create a copy of Inspection
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? inspectionId = freezed,Object? inspectorId = null,Object? batchId = freezed,Object? farmerName = freezed,Object? location = freezed,Object? capturedLocation = freezed,Object? town = freezed,Object? chapter = freezed,Object? exactLocation = freezed,Object? truckNumber = freezed,Object? company = freezed,Object? buyerName = freezed,Object? waybillNumber = freezed,Object? analysisType = freezed,Object? quantity = null,Object? quantityBags = null,Object? moistureContent = null,Object? nutCount = null,Object? kor = null,Object? goodKernels = null,Object? spottedKernels = null,Object? immatureKernels = null,Object? oilyKernels = null,Object? voidKernels = null,Object? fullyDamagedKernels = null,Object? emptyShells = null,Object? totalDefective = null,Object? totalSpotted = null,Object? imageUrls = null,Object? status = null,Object? notes = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? completedAt = freezed,}) {
...
class _Inspection implements Inspection {
  const _Inspection({required this.id, this.inspectionId, required this.inspectorId, this.batchId, this.farmerName, this.location, this.capturedLocation, this.town, this.chapter, this.exactLocation, this.truckNumber, this.company, this.buyerName, this.waybillNumber, this.analysisType, this.quantity = 0.0, this.quantityBags = 0, this.moistureContent = 0.0, this.nutCount = 0, this.kor = 0.0, this.goodKernels = 0.0, this.spottedKernels = 0.0, this.immatureKernels = 0.0, this.oilyKernels = 0.0, this.voidKernels = 0.0, this.fullyDamagedKernels = 0.0, this.emptyShells = 0.0, this.totalDefective = 0.0, this.totalSpotted = 0.0, final  List<String> imageUrls = const [], this.status = InspectionStatus.pending, this.notes, this.createdAt, this.updatedAt, this.completedAt}): _imageUrls = imageUrls;
