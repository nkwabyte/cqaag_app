                ...
                children: [
                  ...
                  _buildContentSection(
                    ...
                    bullets: [
                      ...
                      'Drobo-Dormaa Chapter — Encompasses Drobo, Dormaa districts, Jaman South, the Ahafo Region, and the Western regions — thrives in the fertile heartland, home to many processing facilities and dense cashew farms that drive local value addition.',
                      'Techiman-Wenchi-Bole Chapter — Spans Wenchi (HQ), Techiman, Bono East, Savannah, and the Northern Regions — anchors the association\'s headquarters and central trading logistics, reaching into the northern savannah zones where vast plantations and trading markets fuel Ghana\'s position as a top producer.',
                      'Tema Port Chapter — Serves the Tema and Takoradi ports, all coastal regions (Greater Accra, Central, Western, Volta), Ashanti and Eastern regions, as well as the Oti Region — focuses on the vital export and processing logistics chain, linking inland production to international shipping lines through port warehouses.',
                    ],
                    footer:
